...
public class DatabaseLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        authors.add(new Author("sholderness", "Sarah",  "Holderness", "password"));
        authors.add(new Author("tbell", "Tom",  "Bell", "password"));
        authors.add(new Author("efisher", "Eric",  "Fisher", "password"));
        authors.add(new Author("csouza", "Carlos",  "Souza", "password"));
